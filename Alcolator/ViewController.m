...
//  Alcolator
//
//  Created by Marius Horga on 11/19/14.
...
- (void)viewDidLoad {
    ...
    self.beerPercentTextField.alpha = 1;
    [self.beerPercentTextField setFont:[UIFont fontWithName:@"HelveticaBold" size:18]];
    self.beerPercentTextField.textColor = [UIColor colorWithRed:.1 green:.5 blue:.9 alpha:1];
    ...
    self.calculateButton.backgroundColor = [UIColor colorWithRed:.1 green:.5 blue:.9 alpha:1];
    ...
    [self.resultLabel setFont:[UIFont fontWithName:@"HelveticaBold" size:18]];
    self.resultLabel.textColor = [UIColor colorWithRed:.1 green:.5 blue:.9 alpha:1];
}
...
- (void)viewWillLayoutSubviews {
    ...
    CGFloat itemHeight = self.view.frame.size.height / 12.9;
...
- (void)textFieldDidChange:(UITextField *)sender {
    ...
    if (enteredNumber == 0) {
        // The user typed 0, or not a number, so clear the field
        sender.text = nil;
    }
}
